...
/******/ 	var hotCurrentHash = "60afa2ceffc06d27ce57"; // eslint-disable-line no-unused-vars
...
var _app = __webpack_require__("./src/js/app.js");
...
var isActiveFunc = function isActiveFunc(match) {
    return match;
};
...
var Links = function Links() {
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            ...
            { exact: true, isActive: isActiveFunc, activeClassName: 'active', className: 'button', to: '/' },
            'Home'
        ),
        _react2.default.createElement(
            _reactRouterDom.NavLink,
            { strict: true, isActive: isActiveFunc, activeClassName: 'active', className: 'button', to: '/one' },
            'One'
        ),
        _react2.default.createElement(
            _reactRouterDom.NavLink,
            { strict: true, isActive: isActiveFunc, activeClassName: 'active', className: 'button', to: '/two' },
            'Two'
        ),
        _react2.default.createElement(
            _reactRouterDom.NavLink,
            { strict: true, isActive: isActiveFunc, activeClassName: 'active', className: 'button',
                to: '/three/hello' },
            '??'
        )
    );
        ...
        _react2.default.createElement(
            ...
            _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(_reactRouterDom.Route, { strict: true, path: '/one', component: One }),
                    _react2.default.createElement(_reactRouterDom.Route, { strict: true, path: '/two', component: Two }),
                    _react2.default.createElement(_reactRouterDom.Route, { strict: true, path: '/three/:page', component: Three }),
                    _react2.default.createElement(_reactRouterDom.Route, { strict: true, component: PageNotFound })
                )
            )
        )
    );
...
/******/ });
//# sourceMappingURL=app.60afa2ceffc06d27ce57.js.map